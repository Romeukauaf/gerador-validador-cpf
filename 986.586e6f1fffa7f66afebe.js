...
var _getGithubCornerStyles = __webpack_require__(103);
...
var esm = __webpack_require__(395);
...
var MASK_PROPS = {
  // common
  mask: prop_types_default().oneOfType([(prop_types_default()).array, (prop_types_default()).func, (prop_types_default()).string, prop_types_default().instanceOf(RegExp), prop_types_default().oneOf([Date, Number, imask/* default.Masked */.Z.Masked]), prop_types_default().instanceOf(imask/* default.Masked */.Z.Masked)]),
  ...
  overwrite: (prop_types_default()).bool,
  // events
  ...
  autofix: (prop_types_default()).bool,
  // number
  ...
  function (_React$Component) {
    ...
    _createClass(MaskedComponent, [{
      ...
      value: function initMask() {
        ...
        this.maskRef = (0,imask/* default */.Z)(this.element, maskOptions).on('accept', this._onAccept.bind(this)).on('complete', this._onComplete.bind(this));
...
function ProgressBar(_ref) {
  ...
  var classNames = isFn(className) ? className({
    rtl: rtl,
    type: type,
    defaultClassName: clsx_m/* default.apply */.Z.apply(void 0, defaultClassArr)
  }) : clsx_m/* default.apply */.Z.apply(void 0, [].concat(defaultClassArr, [className])); // 🧐 controlledProgress is derived from progress
...
var Toast = function Toast(props) {
  ...
  var cssClasses = isFn(className) ? className({
    ...
    type: type,
    defaultClassName: clsx_m/* default.apply */.Z.apply(void 0, defaultClassArr)
  }) : clsx_m/* default.apply */.Z.apply(void 0, [].concat(defaultClassArr, [className]));
  ...
  return (0,react.createElement)("div", {
    ...
    var swag = {
      className: isFn(className) ? className({
        position: position,
        rtl: rtl,
        defaultClassName: (0,clsx_m/* default */.Z)("Toastify"
        /* CSS_NAMESPACE */
